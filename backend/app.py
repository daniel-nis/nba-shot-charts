...
import os
from flask_cors import CORS
from cache import initialize_cache_db, get_cached_data, cache_data
...
def get_shot_chart():
    ...
    # Check the cache
    cached_data = get_cached_data(player_name)
    if cached_data:
    ...
    try:
        ...
        # Cache the data
        cache_data(player_name, image_base64, stats_data, favorite_shots_data, team_color)

        # Return the data
        return jsonify({
            'image_base64': image_base64,
            'statistics': stats_data,
            'favorite_shots': favorite_shots_data,
